  ...
  render: function() {
    return (
      <div>
        ...
        <title>Ascend Governance - Corporate Governance Excellence</title>
        <meta name="description" content="Professional corporate governance consultancy providing expert guidance on board composition, compliance, and organizational leadership." />
        ...
        <div id="mainContent" className="content hero-bg min-h-screen flex items-center justify-center">
          ...
          <div className="hero-content text-center max-w-2xl mx-auto px-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button id="enterBtn" className="btn-primary text-lg px-8 py-4 rounded-lg shadow-subtle hover:shadow-elevated transition-all duration-300">
                Enter Platform
              </button>
