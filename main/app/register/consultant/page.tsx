  ...
  return (
    <>
              ...
              <form 
                ...
                onSubmit={async (e) => {
                  ...
                  try {
                    ...
                    showSuccess('Registration submitted! Your application is pending approval. Redirecting...');
                ...
                <div className="pt-4 border-t border-border">
                  <div className="flex flex-col sm:flex-row gap-4">
                    <button 
                      type="submit" 
                      disabled={isLoading}
                      className="btn-primary flex-1 text-lg py-3 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                    >
                      {isLoading ? (
                        <>
      ...
      <Notification
        ...
        duration={notificationType === 'success' ? 2000 : 5000}
      />
    </>
  );
}
